...
class GroundTruthRepublisher(object):
    ...
    def __init__(self, namespace='ground_truth_republisher'):
        ...
        self.pub = rospy.Publisher(
            "/ground_truth/state", Odometry, queue_size=1)
        self.sub = rospy.Subscriber(
            "/ground_truth/state_raw", Odometry, self.handle_pose)
    ...
    def handle_pose(self, msg):
        ...
        pos = np.dot(rotationNeg90Deg, np.array(
        ...
        q_new = tf.transformations.quaternion_multiply(
            q_rot, [msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w])
        ...
        lin = np.dot(rotationNeg90Deg, np.array(
